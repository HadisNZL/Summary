...
public class SharePrefenceUtil {
    ...
    public static final String VTIME = "vtime";//录音时间
     ...
     * @param token
     */
    public static void setVtime(String time) {
        getEditor().putString(VTIME, time).apply();
    }

    public static String getVtime() {
        return getSp().getString(VTIME, "");
    }
