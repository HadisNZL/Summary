package com.example.hadis.summary.autoscrollviewpager;
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if (stopScrollWhenTouch) {
            if ((action == MotionEvent.ACTION_DOWN) && isAutoScroll) {
                isStopByTouch = true;
                stopAutoScroll();
            } else if ((ev.getAction() == MotionEvent.ACTION_UP || ev
                .getAction() == MotionEvent.ACTION_CANCEL) && isStopByTouch) {
                startAutoScroll();
            }
        }
        ...
        if (slideBorderMode == SLIDE_BORDER_MODE_TO_PARENT || slideBorderMode == SLIDE_BORDER_MODE_CYCLE) {
             ...
             * one.
             */
           /* if ((Math.abs(touchY = downY)) > Math.abs(touchX - downX)) {
